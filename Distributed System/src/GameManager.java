...
public class GameManager {
	...
	*/
	...
	public String displayGameState(){
		return "<<Current player turn: " + getCurrentPlayerTurn() + 
			">> <<Player count: " + getPlayerCount() + 
			">> <<Current player bet amount: " + getCurrentPlayerBetAmount() + 
			">> <<Game ID: " + getGameID() + 
			">> <<Current bet call: " + getCurrentBetCall() + 
			">> <<Current player ID: " + getCurrentPlayerIDTurn() + 
			">>";
	}
